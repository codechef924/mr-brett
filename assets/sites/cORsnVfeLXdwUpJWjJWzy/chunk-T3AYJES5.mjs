function e(t,a){return{bodyClassName:"framer-body-augiA20Il",breakpoints:[{hash:"72rtr7",mediaQuery:"(min-width: 1440px)"},{hash:"1t9mxuk",mediaQuery:"(min-width: 810px) and (max-width: 1439px)"},{hash:"10wuu6n",mediaQuery:"(max-width: 809px)"}],customHTMLHeadStart:`
